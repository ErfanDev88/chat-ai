...
function OverlayMenu() {
  ...
  return (
    <nav className="flex flex-col justify-between w-[70%] h-full overlayMenu py-[25px] px-[20px] pr-[30px] text-[#DFD0B8] fixed">
      ...
      {isLoggedin ? (
        <div className="w-full flex justify-start items-center gap-x-[30px] py-[12px] profile">
          <button
            type="button"
