...
function Sidebar() {
  ...
  return (
    <>
      <div className="flex justify-between items-center px-[20px] py-[15px] w-full mobile-nav fixed top-0">
        <Link
          className="font-[700] tracking-[4px] text-[23px] text-[#DFD0B8] flex justify-center items-center no-underline"
          href={"/"}
        >
          <Image
            src={logo}
        ...
        <button
          type="button"
          className="border-none shadow-none bg-transparent hover:bg-transparent cursor-pointer"
          onClick={() => setIsOverlaymenuOpened(!isOverlayMenuOpened)}
        >
          {isOverlayMenuOpened ? (
            <svg
              width="30"
            ...
            >
              <path
                d="M3.75 6.75H20.25M9.5 12H20.25M3.75 17.25H20.25"
                stroke="#DFD0B8"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      {isOverlayMenuOpened && <OverlayMenu />}
      <nav className="hidden flex-col justify-between w-auto h-screen sidebar py-[25px] px-[20px] pr-[30px] text-[#DFD0B8] relative">
        {isLoggedin ? (
          <button
        ...
        <div className="flex flex-col gap-y-[40px] justify-between items-start">
          <Link
            className="font-[700] tracking-[4px] text-[33px] text-[#DFD0B8] flex justify-center items-center no-underline"
            href={"/"}
          >
            <Image
              src={logo}
          ...
          {isLoggedin ? null : (
            <section className="Sidebarlogin p-[10px] flex flex-col justify-center items-center bg-[#393E46]">
              ...
              <div className="flex justify-between items-between gap-x-[20px] mt-[10px]">
                <button
                  type="button"
                  className="signupBtn text-[#393E46] p-[8px] text-[13px] font-[500] border-none flex items-center justify-center gap-x-[4px] "
                ...
                <button
                  type="button"
                  className="loginBtn bg-transparent shadow-none text-[#DFD0B8] p-[8px] px-[11px] text-[13px] font-[500] border-none flex items-center justify-center gap-x-[4px] "
        ...
        {isLoggedin ? (
          <div className="w-full flex justify-start items-center gap-x-[20px] py-[12px] profile">
            ...
            >
              ...
              {isOpened ? <span>{user.name}</span> : null}
            </button>
            {isOpened ? (
              <button
                type="button"
